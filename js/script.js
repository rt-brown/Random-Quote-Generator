...
function printQuote(){
  ...
  message = "<p class='quote'>" + randomQuote + '</p>' + '<p class="source">' + randomsource +
  '<span class="citation">' + randomLocation + '</span>' +
  '<span class="year">' + randomYear + '</span>' + '</p>';
    if(randomYear === null){
      message = "<p class='quote'>" + randomQuote + '</p>' + '<p class="source">' + randomsource +
      '<span class="citation">' + randomLocation + '</span>' + '</p>';
